...
public class ContentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int TYPE_PREVIEW_IMAGE = 2;
    public static final int TYPE_PREVIEW_DESCRIPTION = 3;
    ...
    public ContentAdapter(Context context, ArrayList<ItemObject> datas) {
...
//            }
            ...
            viewHolder.viewTitle.setText(video.judul);
            viewHolder.viewDescription.setText(video.description);
            viewHolder.viewLayer.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
